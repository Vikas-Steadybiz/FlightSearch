...
import com.example.FlightSearch.domain.request.search.TPA_Extensions;
...
public class OTA_AirLowFareSearchRQ {
    ...
    ArrayList<com.example.FlightSearch.domain.request.OriginDestinationInformation> OriginDestinationInformation = new ArrayList<>();
...
//    }
    ...
    public ArrayList<com.example.FlightSearch.domain.request.OriginDestinationInformation> getOriginDestinationInformation() {
        return OriginDestinationInformation;
    }

    public void setOriginDestinationInformation(ArrayList<com.example.FlightSearch.domain.request.OriginDestinationInformation> originDestinationInformation) {
        OriginDestinationInformation = originDestinationInformation;
    }
